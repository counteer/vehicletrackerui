...
const MapComponent: React.FC<{ itemId: number }> = ({itemId}) => {
    ...
    return (
        <div>
            <MapContainer className="map-container" center={central} zoom={13} zoomControl={false} style={{height: '400px', width: '400px'}}
                          dragging={false}>
